...
public class RangeModuleTableShardingAlgorithm implements RangeShardingAlgorithm<Long> {
    ...
    public Collection<String> doSharding(
        ...
        // 求分表后缀名的递归算法
        List<Integer> list = counTableNum(i, lowerEndpoint, upperEndpoint, arrs);
     ...
     * @return
     */
    private List<Integer> counTableNum(int i, long lowerEndpoint, long upperEndpoint, List<Integer> arrs){
        ...
        if(left < upperEndpoint && upperEndpoint <= right){
            ...
            i++;
            return counTableNum(i, lowerEndpoint, upperEndpoint, arrs);
        }
    }
